...
const adminRoutes = require('./routes/adminRoutes');
const sellerRoutes = require('./routes/sellerRoutes');
const sellerController = require('./controllers/sellerController'); // Added this import
const notificationRoutes = require('./routes/notificationRoutes');
const clientAddressRoutes = require('./routes/clientAddressRoutes');
const clientInfoRoutes = require('./routes/clientInfoRoutes');
const cloudinary = require('cloudinary').v2;
...
// New endpoint for subtracting earnings from monthly total
app.get('/api/seller/subtract-earnings/:amount', authMiddleware, async (req, res) => {
  try {
    // Make sure user is authorized (simplified auth check)
    ...
    const amountToSubtract = parseFloat(req.params.amount);
    ...
    // Get current month's earnings (simplified)
    ...
    // Calculate new amount after subtraction
    const newAmount = totalEarnings - amountToSubtract;
