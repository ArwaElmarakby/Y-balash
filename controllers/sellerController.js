...
exports.confirmCashPayment = async (req, res) => {
    ...
    try {
        ...
        // حساب المبلغ الأصلي قبل الخصم
        const originalAmount = order.totalAmount + (order.discountFromPoints || 0);
        
        // حساب النقاط بناءً على المبلغ الأصلي قبل الخصم
        const pointsToAdd = Math.floor(originalAmount / 40) * 5;
