...
exports.cashPayment = async (req, res) => {
    ...
    try {
        ...
        // Apply points discount if exists
        const discountFromPoints = cart.discountFromPoints || 0;
        const finalAmount = totalPrice - discountFromPoints;
        ...
        await createNotification(
            ...
            'new_order',
            'New Order Received',
            `New cash order #${order._id} for ${finalAmount} EGP`,
            order._id
        );
